...
def train_model():
    ...
    for epoch in range(epochs):
        ...
        if val_loss < best_val_loss:
            ...
            patience_counter = 0
            torch.save(model.state_dict(), 'best_mobilenetv2_noclass.pth')
        else:
            patience_counter += 1
    ...
    # Save final model
    torch.save(model.state_dict(), 'final_mobilenetv2_noclass.pth')
    logging.info("Final model saved.")

    # Save training history
    with open('mnv2_training_history_noclass.pkl', 'wb') as f:
