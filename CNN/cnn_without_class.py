# -*- coding: utf-8 -*-
"""cnn_without class_150.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_g8qGRFXrNKPEfTaspSTdKC5_iLVv3CR
"""
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), '/content/drive/MyDrive/dm project/cnn/cnn_best_model_150.pth')
    else:
        patience_counter += 1
...
with open('/content/drive/MyDrive/dm project/cnn/cnn_training_history_150.pkl', 'wb') as f:
...
plt.tight_layout()
plt.savefig('/content/drive/MyDrive/dm project/cnn/cnn_loss_plot_150.png')
plt.show()
...
model.load_state_dict(torch.load('/content/drive/MyDrive/dm project/cnn/cnn_best_model_150.pth'))
model.eval()
...
plt.ylabel('True')
plt.savefig('/content/drive/MyDrive/dm project/cnn/cnn_con_mat_150.png')
plt.show()
...
plt.xlabel('Predicted')
plt.ylabel('True')
plt.savefig('/content/drive/MyDrive/dm project/cnn/cnn_n_con_mat_150.png')
plt.show()
...
plt.legend()
plt.savefig('/content/drive/MyDrive/dm project/cnn/cnn_roc_curve_150.png')
plt.show()
...
safe_load_model('/content/drive/MyDrive/dm project/cnn/cnn_best_model_150.pth', model)
