# -*- coding: utf-8 -*-
"""vit_new_with_class.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vXGko28nld7SsJWRurRt6eTQgkuUjYTv
"""
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), '/home/sshultan/dm_project/new/nvit/vitwwc_best_model.pth')
    else:
        patience_counter += 1
...
with open('/home/sshultan/dm_project/new/nvit/vitwwc_training_history.pkl', 'wb') as f:
...
plt.tight_layout()
plt.savefig('/home/sshultan/dm_project/new/nvit/vitwwc_loss_acc_plot.png')
plt.show()
...
model.load_state_dict(torch.load('/home/sshultan/dm_project/new/nvit/vitwwc_best_model.pth', map_location=device))
model.to(device)
model.eval()
...
plt.ylabel('True')
plt.savefig('/home/sshultan/dm_project/new/nvit/wwc_vit_cm_150.png')
plt.show()
...
plt.xlabel('Predicted')
plt.ylabel('True')
plt.savefig('/home/sshultan/dm_project/new/nvit/wwc_vit_ncm_150.png')
plt.show()
...
plt.legend()
plt.savefig('/home/sshultan/dm_project/new/nvit/wwc_roc_curve_150.png')
plt.show()
