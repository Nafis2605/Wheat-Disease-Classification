# -*- coding: utf-8 -*-
"""cvt_150_without_class.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1N6DZJ4_d_QCerejzmoOLczTUGt7KaHGq
"""
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), '/content/drive/MyDrive/dm project/cvt/cvt_best_model_150.pth')
    else:
        patience_counter += 1
...
with open('/content/drive/MyDrive/dm project/cvt/cvt_training_history.pkl', 'wb') as f:
...
plt.tight_layout()
plt.savefig('/content/drive/MyDrive/dm project/cvt/cvt_loss_acc_plot.png')
plt.show()
...
model.load_state_dict(torch.load('/content/drive/MyDrive/dm project/cvt/cvt_best_model_150.pth'))
model.eval()
...
plt.ylabel('True')
plt.savefig('/content/drive/MyDrive/dm project/cvt/confusion_matrix_150.png')
plt.show()
...
plt.xlabel('Predicted')
plt.ylabel('True')
plt.savefig('/content/drive/MyDrive/dm project/cvt/n_con_mat_150.png')
plt.show()
...
plt.legend()
plt.savefig('/content/drive/MyDrive/dm project/cvt/roc_curve_150.png')
plt.show()
...
safe_load_model('/content/drive/MyDrive/dm project/cvt/cvt_best_model_150.pth', model)
